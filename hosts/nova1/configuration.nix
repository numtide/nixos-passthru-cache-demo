...
{ imports =
  ...
  networking.hostName = "nova1"; # Define your hostname.
  ...
  users.users.nixcon = { isNormalUser = true; description = "NixCon"; extraGroups = [ "networkmanager" "wheel" ]; packages = with 
    pkgs; [
    #  thunderbird
    ];
  };
  ...
  services.displayManager.autoLogin.enable = true; services.displayManager.autoLogin.user = "nixcon";
